...
## 桌 面
### 桌面图标
系统默认放置了计算机、回收站、个人三个图标，鼠标左键双击即可打开页面，图标说明如下。 
...
|![](image/icon9.png)|	托盘菜单，包含了输入法、网络连接、U盘管理、日期等
...
| 图标 | 说明 |
| :------------ | :------------ |
|![](image/icon10.png)|	复制剪切板上的该内容 |
|![](image/icon11.png)|	编辑剪切板上的该内容 |
|![](image/icon12.png)|	删除剪切板上的该内容 |	
...
### 输入法
系统提供了多个输入法供用户选择，右键点击输入法图标，选择“输入法”即可看到，如图 12所示。

![图 12 输入法选择](image/12.png)

### 网 络
用户通过鼠标左键点击任务栏上的网络图标，可根据需要选择有线和无线两种网络连接方式。
...
## 开始菜单
单击“开始菜单”按钮，如图 17所示，为按字母排序显示系统应用。
...
### 快捷功能键
#### 用户信息
点击“![](image/icon13.png)”，查看用户信息。

#### 计算机
点击“![](image/icon14.png)”，进入文件管理器的计算机目录。

#### 控制面板
点击“![](image/icon15.png)”，进入控制面板。

### 关机菜单
点击“电源”按钮，弹出的关机选项界面如图 19所示。
