...
![图 5 音频设置-big](image/5.png)

- **播放列表**

播放列表设置包括行为、兼容性、歌曲显示、高级四个部分，如图 6所示。

![图 6 播放列表设置-big](image/6.png)

- **歌曲信息**

歌曲信息设置包括专辑封面个弹出信息两个部分，如图 7所示。

![图 7 歌曲信息设置-big](image/7.png)

- **插件设置**

插件设置提供了一些详细设置项，如图 8所示。

![图 8 插件设置-big](image/8.png)
