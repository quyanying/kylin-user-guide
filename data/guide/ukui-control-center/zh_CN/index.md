...
## 网 络
网络主要包含了网络连接、VPN、代理。此处主要说明配置网络。

![图 19 网络-big](image/19.png)
...
1）打开编辑网络连接的页面，输入IP地址与掩码，如图 24所示（图中的地址仅为示例）。
...
点击“添加新用户”，定义账户名称、密码、账户类型等如图 30所示。

- 编辑用户

![图 31 编辑用户](image/31.png)
<br>
...
![图 37 安全中心-big](image/37.png)

### 更 新
检测系统是否有可用更新。

![图 38 系统更新-big](image/38.png)
